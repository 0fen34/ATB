...
~\glqq{}Late Game\grqq{}:
	...
	\item
	Der Kreis gilt als durchbrochen, wenn die Unterlage ununterbrochen von außerhalb bis innerhalb des Kreises sichtbar ist.
...
\begin{enumerate}[label={(\arabic*)}]
	...
	\begin{longtable}[r]{p{.07\textwidth}  p{.15\textwidth}  p{.65\textwidth}} %TODO currently manually fitted to indentation. make this dynamic
		...
		Läuft ein Countdown aus, wird ein Element doppelt genannt oder gibt eine Person auf, verliert sie und trinkt.\\
		...
		Leert die Person am Zug ihr Getränk, so zählt es als abgesetzt.\\
		\bottomrule
	\end{longtable}
\end{enumerate}

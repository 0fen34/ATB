...
\begin{enumerate}[label={(\arabic*)}]
	\item\label{Allgemeine_Regelungen:Ehre:Ehrenmensch}
	Allgemein, aber insbesondere wo keine neutralen Beobachtenden beteiligt sind, verhalten sich die Spielenden als Ehrenmensch.
...
\section{Regelverstöße}
\begin{enumerate}[label={(\arabic*)}]
	\item 
	Wird eine Person auf einen Regelverstoß hingewiesen, so ist die entsprechende Strafe,
	wenn nicht anderweitig spezifiziert, sofort zu entrichten und beträgt einen Schluck.
	Insbesondere verhalten sich alle Parteien entsprechend~\ref{Allgemeine_Regelungen:Ehre:Ehrenmensch}.
\end{enumerate}

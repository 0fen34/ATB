...
\subsubsection{} Allgemein, aber insbesondere wo keine neutralen Beobachtenden beteiligt sind, verhalten sich die Spielenden als Ehrenmensch.
Es werden keine Regelverletzungen bewusst begangen oder fälschlich angeprangert oder abgestritten.

\subsubsection{}\label{Allgemeine_Regelungen:Ehre:Spirit}
...
\subsubsection{}\label{Allgemeine_Regelungen:Trinken:Trink}
Wer spielt, trinkt.
...
\subsubsection{}\label{Allgemeine_Regelungen:Getränke:Umrechnung}
...
\subsubsection{}\label{Allgemeine_Regelungen:Getränke:Abfüllen}
